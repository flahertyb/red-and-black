// Basic test program for assignment 8,
// based on the test program for assignment 7.
...
public class TestVisitor {
    ...
    private void creation (int nargs, Comparator<Integer> c) {
        try {
            ...
            // (one, dave) (two, dave) (two, bob) (one alice)
    ...
    private void visitors () {
        try {
            ...
            //System.out.println(f7.accept(v2).toString());
            //System.out.println(f7.accept(v2).get(one).toString());
            assertTrue ("accept7,2,2",
                        f7.accept(v2).get(two).equals("BobBob"));
            //System.out.println(f7.accept(v2).toString());
            //System.out.println(f7.accept(v2).get(two).toString());
